...
class ConversationControl(BasePage):
    ...
    def update_chat_suggestions(self, conversation_id, new_suggestions, is_updated, user_id):
        ...
        with Session(engine) as session:
            ...
            data_source["chat_suggestions"] = [[x] for x in new_suggestions.iloc[:, 0].tolist()]
